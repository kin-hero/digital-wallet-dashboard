...
const getTheMostRecentTransactionOfAddress = async (address: EthereumAddress): Promise<EtherscanTxResponse> => {
...
export default getTheMostRecentTransactionOfAddress;
